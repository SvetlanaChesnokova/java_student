...
public class GroupData {
  ...
  //указываем где уже описана связб между этими данными
  @ManyToMany(mappedBy = "groups")
  private Set<ClientData> contacts = new HashSet<ClientData>();

  public Clients getContacts() {
    return new Clients (contacts);
  }
